...
$_LANG['msg_un_registered'] = '<font class=\"us_name2\">用户名已经存在,请重新输入。<\font>';
...
$_LANG['agreement'] = "<a class=\"reg_agree\"  href=\"article.php?cat_id=-1\" target=\"_blank\">已阅读并接受《用户协议》</a>";
...
$_LANG['passport_js']['username_shorter'] = '<font class=\"us_name2\">请输入合法的邮件地址或者手机号。</font>';
$_LANG['passport_js']['username_invalid'] = '- 用户名只能是由字母数字以及下划线组成。';
$_LANG['passport_js']['password_empty'] = '- 登录密码不能为空。';
$_LANG['passport_js']['password_shorter'] = '<font class=\"us_name2\">不能少于 6 个字符。</font>';
...
$_LANG['passport_js']['msg_un_registered'] = '<font class=\"us_name2\">用户名已经存在,请重新输入</font>';
$_LANG['passport_js']['msg_can_rg'] = '<font class=\"us_rg\">可注册</font>';
$_LANG['passport_js']['msg_email_blank'] = '<font class=\"us_name2\">邮件地址不能为空</font>';
$_LANG['passport_js']['msg_email_registered'] = '<font class=\"us_name2\">邮箱已存在,请重新输入</font>';
$_LANG['passport_js']['msg_email_format'] = '<font class=\"us_name2\">邮件地址不合法</font>';
...
/* 密码找回问题 */
$_LANG['passwd_questions']['friend_birtblockTitleay'] = '我最好朋友的生日？';
