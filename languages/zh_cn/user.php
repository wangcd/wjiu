...
$_LANG['msg_email_format'] = '<font class=\"us_rg\">邮件地址不合法</font>';
...
$_LANG['agreement'] = "<font style=\"font-size:14px;\">我已看过并接受《<a href=\"article.php?cat_id=-1\" style=\"color:#003399\" target=\"_blank\">用户协议</a>》</font>";
...
$_LANG['passport_js']['username_shorter'] = '<font class=\"us_rg\"  >用户名长度不能少于 3 个字符</font>';
$_LANG['passport_js']['username_invalid'] = '- 用户名只能是由字母数字以及下划线组成。';
$_LANG['passport_js']['password_empty'] = '- 登录密码不能为空。';
$_LANG['passport_js']['password_shorter'] = '<font class=\"us_name2\">6-20个字符，可由英文、数字或符号组成</font>';
$_LANG['passport_js']['confirm_password_invalid'] = '<font class=\"us_rg\">两次输入密码不一致</font>';
...
$_LANG['passport_js']['msg_can_rg'] = '<font class=\"can_rg\"></font>';
$_LANG['passport_js']['msg_email_blank'] = '<font class=\"us_rg\">邮件地址不能为空</font>';
$_LANG['passport_js']['msg_email_registered'] = '* 邮箱已存在,请重新输入';
$_LANG['passport_js']['msg_email_format'] = '<font class=\"us_rg\" >邮件地址不合法</font>';
