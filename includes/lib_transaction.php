 ...
 *
 * @access  public
 * @param   array       $profile       array_keys(user_id int, email string, sex int, birtblockTitleay string);
 *
 * @return  boolen      $bool
 */
function edit_profile($profile)
{
    ...
    if (!empty($profile['birtblockTitleay']))
    {
        $cfg['bday'] = $profile['birtblockTitleay'];
    }
...
function get_profile($user_id)
{
    ...
    $info  = array();
    $infos = array();
    $sql  = "SELECT user_name, sex, question, answer, rank_points, pay_points,user_money, user_rank,".
    ...
    $info['birtblockTitleay']    = isset($infos['birtblockTitleay']) ? $infos['birtblockTitleay'] : '';
