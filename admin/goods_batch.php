...
elseif ($_REQUEST['act'] == 'edit')
{
    ...
    $sql = "SELECT DISTINCT goods_id, goods_sn, goods_name, market_price, shop_price, goods_number, integral, give_integral,integral_putong, brand_id, is_real FROM " . $ecs->table('goods') . $where;
        ...
        if (!empty($_POST['goods_id']))
        {
            foreach ($_POST['goods_id'] AS $goods_id)
            {
                ...
                $goods = array(
					...
					'integral_putong'      => intval($_POST['integral_putong'][$goods_id]),
    ...
    else
    {
        ...
        if (!empty($_POST['goods_id']))
        {
            foreach ($_POST['goods_id'] AS $goods_id)
            {
				...
				/***14-11-12**/
				if (trim($_POST['integral_putong']) != '')
                {
                    $goods['integral_putong'] = intval($_POST['integral_putong']);
                }
				/***14-11-12end**/
