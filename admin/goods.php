...
if ($_REQUEST['act'] == 'list' || $_REQUEST['act'] == 'trash')
{
    ...
    //$smarty->assign('cat_list',     cat_list(0, $cat_id)); //授权分类管理商品_修改过 by www.edait.cn
    $smarty->assign('cat_list',     sq_list($cat_id));	     //授权分类管理商品_新增加 by www.edait.cn
...
elseif ($_REQUEST['act'] == 'add' || $_REQUEST['act'] == 'edit' || $_REQUEST['act'] == 'copy')
{
    ...
    else
    {
        ...
        {
            //$other_cat_list[$cat_id] = cat_list(0, $cat_id); //授权分类管理商品_修改过 by www.edait.cn
            $other_cat_list[$cat_id] = sq_list($cat_id);       //授权分类管理商品_新增加 by www.edait.cn
        }
    ...
    //$smarty->assign('cat_list', cat_list(0, $goods['cat_id'])); //授权分类管理商品_修改过 by www.edait.cn
    $smarty->assign('cat_list', sq_list($goods['cat_id'])); //授权分类管理商品_新增加 by www.edait.cn
    $smarty->assign('brand_list', get_brand_list());
...
elseif ($_REQUEST['act'] == 'insert' || $_REQUEST['act'] == 'update')
{
    ...
    /* 处理商品数据 */
	$lianmeng_price = !empty($_POST['lianmeng_price']) ? $_POST['lianmeng_price'] : 0;//14-11-8
	$integral_peihuo = !empty($_POST['integral_peihuo']) ? $_POST['integral_peihuo'] : 0;//14-11-8
	$integral_putong = !empty($_POST['integral_putong']) ? $_POST['integral_putong'] : 0;//14-11-8
	...
	$integral_putong = isset($_POST['integral_putong']) ? intval($_POST['integral_putong']) : '0';//14-11-10
    ...
    if ($is_insert)
    {
        if ($code == '')
        {
            $sql = "INSERT INTO " . $ecs->table('goods') . " (goods_name, goods_name_style, goods_sn, " .
                    ...
                    "seller_note, goods_weight, goods_number, warn_number, integral, give_integral,integral_putong, is_best, is_new, is_hot, " .
                    "is_on_sale, is_alone_sale, is_shipping, goods_desc, add_time, last_update, goods_type, rank_integral, suppliers_id,lianmeng_price,integral_peihuo,integral_putong)" .
                "VALUES ('$_POST[goods_name]', '$goods_name_style', '$goods_sn', '$catgory_id', " .
                    "'$brand_id', '$shop_price', '$market_price', '$is_promote','$promote_price', ".
                    "'$promote_start_date', '$promote_end_date', '$goods_img', '$goods_thumb', '$original_img', ".
                    "'$_POST[keywords]', '$_POST[goods_brief]', '$_POST[seller_note]', '$goods_weight', '$goods_number',".
                    " '$warn_number', '$_POST[integral]', '$give_integral','$integral_putong', '$is_best', '$is_new', '$is_hot', '$is_on_sale', '$is_alone_sale', $is_shipping, ".
                    " '$_POST[goods_desc]', '" . gmtime() . "', '". gmtime() ."', '$goods_type', '$rank_integral', '$suppliers_id','$lianmeng_price','$integral_peihuo','$integral_putong')";
        }
        else
        {
            $sql = "INSERT INTO " . $ecs->table('goods') . " (goods_name, goods_name_style, goods_sn, " .
                    "cat_id, brand_id, shop_price, market_price, is_promote, promote_price, " .
                    "promote_start_date, promote_end_date, goods_img, goods_thumb, original_img, keywords, goods_brief, " .
                    "seller_note, goods_weight, goods_number, warn_number, integral, give_integral,integral_putong is_best, is_new, is_hot, is_real, " .
                    "is_on_sale, is_alone_sale, is_shipping, goods_desc, add_time, last_update, goods_type, extension_code, rank_integral,lianmeng_price,integral_peihuo,integral_putong)" .
                "VALUES ('$_POST[goods_name]', '$goods_name_style', '$goods_sn', '$catgory_id', " .
                    "'$brand_id', '$shop_price', '$market_price', '$is_promote','$promote_price', ".
                    "'$promote_start_date', '$promote_end_date', '$goods_img', '$goods_thumb', '$original_img', ".
                    "'$_POST[keywords]', '$_POST[goods_brief]', '$_POST[seller_note]', '$goods_weight', '$goods_number',".
                    " '$warn_number', '$_POST[integral]', '$give_integral','$integral_putong' ,'$is_best', '$is_new', '$is_hot', 0, '$is_on_sale', '$is_alone_sale', $is_shipping, ".
                    " '$_POST[goods_desc]', '" . gmtime() . "', '". gmtime() ."', '$goods_type', '$code', '$rank_integral','$lianmeng_price','$integral_peihuo','$integral_putong')";
        }
    }
    else
    {
        ...
        $sql = "UPDATE " . $ecs->table('goods') . " SET " .
				...
				"lianmeng_price = '$lianmeng_price', " .
				"integral_peihuo = '$integral_peihuo', " .
				"integral_putong = '$integral_putong', " .
    ...
    if ((isset($_POST['attr_id_list']) && isset($_POST['attr_value_list'])) || (empty($_POST['attr_id_list']) && empty($_POST['attr_value_list'])))
    {
        ...
        if(isset($_POST['attr_id_list']))
        {
            foreach ($_POST['attr_id_list'] AS $key => $attr_id)
            {
				...
				$attr_order = $_POST['attr_order_list'][$key];    // by leah
                if (!empty($attr_value))
                {
                    if (isset($goods_attr_list[$attr_id][$attr_value]))
                    {
						...
						$goods_attr_list[$attr_id][$attr_value]['attr_order'] = $attr_order;  // by leah
                    }
                    else
                    {
                        // 如果原来没有，标记为新增
        ...
        foreach ($goods_attr_list as $attr_id => $attr_value_list)
        {
            foreach ($attr_value_list as $attr_value => $info)
            {
                if ($info['sign'] == 'insert')
                {
                    $sql = "INSERT INTO " .$ecs->table('goods_attr'). " (attr_id, goods_id, attr_value, attr_price , attr_order)".
                            "VALUES ('$attr_id', '$goods_id', '$attr_value', '$info[attr_price]' , '$info[attr_order]')";   // by leah
                }
                elseif ($info['sign'] == 'update')
                {
                   $sql = "UPDATE " .$ecs->table('goods_attr'). " SET attr_price = '$info[attr_price]' , attr_order = '$info[attr_order]'  WHERE goods_attr_id = '$info[goods_attr_id]' LIMIT 1";
                     // by leah
                }
                else
                {
