...
elseif ($_REQUEST['act'] == 'insert')
{
    ...
    $birtblockTitleay = $_POST['birtblockTitleayYear'] . '-' .  $_POST['birtblockTitleayMonth'] . '-' . $_POST['birtblockTitleayDay'];
    ...
    $other['sex']        = $sex;
    $other['birtblockTitleay']   = $birtblockTitleay;
...
elseif ($_REQUEST['act'] == 'edit')
{
    ...
    $sql = "SELECT u.user_name, u.sex, u.birtblockTitleay, u.pay_points, u.rank_points, u.user_rank , u.user_money, u.frozen_money, u.credit_line, u.parent_id, u2.user_name as parent_username, u.qq, u.msn, u.office_phone, u.home_phone, u.mobile_phone".
    ...
    $sql = "SELECT u.user_id, u.sex, u.birtblockTitleay, u.pay_points, u.rank_points, u.user_rank , u.user_money, u.frozen_money, u.credit_line, u.parent_id, u2.user_name as parent_username, u.qq, u.msn,
    ...
    if ($row)
    {
        ...
        $user['sex']            = $row['sex'];
        $user['birtblockTitleay']       = date($row['birtblockTitleay']);
...
elseif ($_REQUEST['act'] == 'update')
{
    ...
    if (!$users->edit_user(array('username'=>$username, 'password'=>$password, 'email'=>$email, 'gender'=>$sex, 'bday'=>$birtblockTitleay ), 1))
    {
