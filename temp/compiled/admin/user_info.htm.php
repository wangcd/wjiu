...
<table width="100%" >
  ...
  <tr>
    <td class="label"><?php echo $this->_var['lang']['birtblockTitleay']; ?>:</td>
    <td><?php echo $this->html_select_date(array('field_order'=>'YMD','prefix'=>'birtblockTitleay','time'=>$this->_var['user']['birtblockTitleay'],'start_year'=>'-60','end_year'=>'+1','display_days'=>'true','month_format'=>'%m')); ?></td>
  </tr>
  <tr>
