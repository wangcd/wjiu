...
?>
        ...
        <?php echo $this->html_options(array('options'=>$this->_var['suppliers_list_name'],'selected'=>$this->_var['goods']['suppliers_id'])); ?>
         ...
         <?php endif; ?>
		   ...
		   <tr>
			<td class="label"><?php echo $this->_var['lang']['lab_lianmeng_price']; ?></td>
			<td><input type="text" id="lianmeng_price" name="lianmeng_price" value="<?php echo $this->_var['goods']['lianmeng_price']; ?>" size="20" /></td>
		  </tr>

		 <tr>
            <td class="label"><?php echo $this->_var['lang']['lab_market_price']; ?></td>
            <td><input type="text" id="market_price"  name="market_price" value="<?php echo $this->_var['goods']['market_price']; ?>" size="20" />
		  ...
		  <tr>
			...
			<input type="text" id="shop_price" name="shop_price" value="<?php echo $this->_var['goods']['shop_price']; ?>" size="20" />
...
?>
		...
		<tr>
		 <td class="label"> <?php echo $this->_var['lang']['lab_integral_peihuo']; ?></td>
		 <td><input type="text" id="integral_peihuo" name="integral_peihuo" value="<?php echo $this->_var['goods']['integral_peihuo']; ?>" size="20" /><input type="button" value="计算普通会员赠送积分" onclick="peihuo_integral()"/></td>
		</tr>
		<tr>
		  <td class="label"> <?php echo $this->_var['lang']['lab_integral_putong']; ?></td>
		 <td><input type="text" id="integral_putong" name="integral_putong" value="<?php echo $this->_var['goods']['integral_putong']; ?>" size="20" /><input type="button" value="计算普通会员赠送积分" onclick="putong_integral()"/></td>
		</tr>
...
?>
    ...
    if (shop_price >0 && rank[rank_id] && document.getElementById('rank_' + rank_id) && parseInt(document.getElementById('rank_' + rank_id).value) == 0)
    {
...
/********配货积分计算******/
function peihuo_integral()
{
	var J_lianmeng_price=document.getElementById('lianmeng_price').value;	
	var J_market_price=document.getElementById('market_price').value;	
	var J_shop_price=document.getElementById('shop_price').value;	
	Math.floor(document.getElementById('integral_peihuo').value=parseInt(J_market_price)-parseInt(J_lianmeng_price));	

}
function putong_integral()
{
	var J_lianmeng_price=document.getElementById('lianmeng_price').value;	
	var J_market_price=document.getElementById('market_price').value;	
	var J_shop_price=document.getElementById('shop_price').value;	
	Math.floor(document.getElementById('integral_putong').value=parseInt(J_shop_price)-parseInt(J_market_price));	
