...
?>
  <tr>
    ...
    <td align="center">
	  ...
	  <!-- 授权分类管理商品_修改过 开始 by www.edait.cn -->
      <a href="javascript:;" onclick="listTable.remove(<?php echo $this->_var['list']['user_id']; ?>, '<?php echo $this->_var['lang']['drop_confirm']; ?>')" title="<?php echo $this->_var['lang']['remove']; ?>"><img src="images/icon_drop.gif" border="0" height="16" width="16"></a>
	  <a href="privilege.php?act=catlist&id=<?php echo $this->_var['list']['user_id']; ?>" title="设置授权分类"><img src="images/icon_output.gif" border="0" height="16" width="16"></a>&nbsp;&nbsp;</td>
	  <!-- 授权分类管理商品_修改过 结束 by www.edait.cn -->
  </tr>
