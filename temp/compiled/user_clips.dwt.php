...
<?php echo $this->_var['lang']['ur_here']; ?> <?php echo $this->_var['ur_here']; ?>
  ...
  <div class="blank"></div>
<div class="block clearfix" style="width:980px;">
  ...
  <div class="AreaR"  style="width:790px;">
    <div class="box">
     <div class="box_1">
      <div class="userCenterBox boxCenterList clearfix" style="_height:1%; padding:5px;">
         
         <?php if ($this->_var['action'] == 'default'): ?>
          <div style="padding:8px;"><font class="f5"><b class="f4" style="border: medium none; color: #EB6100;font-size: 16px; font-weight: bold; margin-left: 5px;"><?php echo $this->_var['info']['username']; ?></b> <?php echo $this->_var['lang']['welcome_to']; ?> <?php echo $this->_var['info']['shop_name']; ?>！</font><br /></div>
          ...
          <?php echo $this->_var['lang']['not_validated']; ?> <a href="javascript:sendHashMail()" style="color:#006bd0;"><?php echo $this->_var['lang']['resend_hash_mail']; ?></a><br />
           ...
           <?php endif; ?>
           <div style="margin:5px 2px; border:1px solid #f7dd98;padding:10px; background-color:#fffad5;">
           <img src="themes/jiuxian/images/note.gif" alt="note" />&nbsp;<?php echo $this->_var['user_notice']; ?>
           </div>
           <br /><br />
          ...
          <h5><span><?php echo $this->_var['lang']['your_account']; ?></span></h5>
           ...
           <!--- <span class="balance"><?php echo $this->_var['lang']['your_surplus']; ?>:<a href="user.php?act=account_log" style="color:#D8000C;"><?php echo $this->_var['info']['surplus']; ?></a></span>--->
          <?php if ($this->_var['info']['credit_line'] > 0): ?>
          <!--<span class="balance"><?php echo $this->_var['lang']['credit_line']; ?>:<?php echo $this->_var['info']['formated_credit_line']; ?></span>--->
          <?php endif; ?>
          <!--<span class="bonus"><?php echo $this->_var['lang']['your_bonus']; ?>:<a href="user.php?act=bonus" style="color:#D8000C;"><?php echo $this->_var['info']['bonus']; ?></a></span>-->
          <span class="cash f_r" style="margin-right:0;"><?php echo $this->_var['lang']['your_integral']; ?>:<?php echo $this->_var['info']['integral']; ?></span>
           </div>
          </div>
...
?>
          ...
          <div style="padding:0 10px;"><?php echo $this->_var['lang']['last_month_order']; ?><?php echo $this->_var['info']['order_count']; ?><?php echo $this->_var['lang']['order_unit']; ?><br /></div>
          ...
          <form action="user.php" method="post" enctype="multipart/form-data" name="formMsg" onSubmit="return submitMsg()">
                  <table width="100%" border="0" cellpadding="3">
                    ...
                    <tr>
                      ...
                      <td>
                      <a href ="<?php echo $this->_var['order_info']['url']; ?>"><img src="themes/jiuxian/images/note.gif" /><?php echo $this->_var['order_info']['order_sn']; ?></a>
                    ...
                    <tr>
                      ...
                      <td><input type="hidden" name="act" value="act_add_message" />
                        <input type="submit" value="<?php echo $this->_var['lang']['submit']; ?>" class="bnt_blue_1" />
                      </td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
...
?>
    <a href="search.php?keywords=<?php echo urlencode($this->_var['tag']['tag_words']); ?>" class="f6"><?php echo htmlspecialchars($this->_var['tag']['tag_words']); ?></a> <a href="user.php?act=act_del_tag&amp;tag_words=<?php echo urlencode($this->_var['tag']['tag_words']); ?>" onclick="if (!confirm('<?php echo $this->_var['lang']['confirm_drop_tag']; ?>')) return false;" title="<?php echo $this->_var['lang']['drop']; ?>"><img src="themes/jiuxian/images/drop.gif" alt="<?php echo $this->_var['lang']['drop']; ?>" /></a>&nbsp;&nbsp;
    <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
    <?php else: ?>
...
?>
    ...
    <div class="blank"></div>
    <h5><span><?php echo $this->_var['lang']['affiliate_member']; ?></span></h5>
    <div class="blank"></div>
   <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
    <tr align="center">
